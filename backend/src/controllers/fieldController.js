...
// GET /api/fields/venue/:venueId
const getVenueFields = async (req, res, next) => {
    try {
...
// POST /api/fields/:fieldId/pricing
...
// GET /api/fields/:fieldId/pricing
